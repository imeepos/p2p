...
- 2026-09-17 [补料]检查点5：静态对端簿接线落地（GUI state/node_build.rs + CLI daemon.rs 各一行，经 p2p::static_peers::wirable_path fail-safe）；效果语义契约更新；聚焦测试 p2p lib 7 + it 4 + gui 6 + ftp 7 全绿，check --tests 双 workspace 0 错。
