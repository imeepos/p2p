      ...
      <DialogContent className="sm:max-w-md" data-testid="friend-role-dialog">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            ...
            >
              <SelectTrigger id="friend-role-select" className="w-full" data-testid="friend-role-select">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Select value={expiryChoice} onValueChange={(value) => setExpiryChoice(value as typeof expiryChoice)}>
          ...
          <div className="flex flex-col gap-1">
            ...
            <Select value={defaultRoleId === "" ? NONE_SENTINEL : defaultRoleId} onValueChange={(value) => void changeDefaultRole(value)}>
