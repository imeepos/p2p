...
export function RemoteAccessCard() {
  ...
  const fpsErrorCode = errors.rdFps?.message;
  const fpsErrorId = "settings-rd-fps-error";
        ...
        error={
          fpsErrorCode != null ? (
            <p
              ...
              data-testid={fpsErrorId}
            >
              {t(`common.validation.${fpsErrorCode}` as I18nKey)}
            </p>
          ) : null
        }
        control={
          <Input
            ...
            max={60}
            className="w-24"
            aria-invalid={fpsErrorCode != null ? true : undefined}
            aria-describedby={fpsErrorCode != null ? fpsErrorId : undefined}
            {...register("rdFps", {
              valueAsNumber: true,
