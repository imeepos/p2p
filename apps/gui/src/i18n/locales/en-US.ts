...
const enUS: typeof zhCN = {
  common: {
    ...
    validation: {
      ...
      ftpRootRequired: "FTP root directory is required",
      ftpUserRequired: "Username is required",
      ftpUserDuplicate: "Duplicate username",
      ftpPasswordRequired: "New users require a password",
      peerIdRequired: "PeerId is required",
      peerIdFormat: "PeerId must be 43-45 base58 characters",
    },
    addressList: {
      add: "Add address",
  ...
  settings: {
    ...
    ftp: {
      title: "FTP service",
      hint: "Root directory and accounts for the FTP file service; changes apply after a node restart",
      root: "Root directory",
      rootHint: "Directory exposed by the FTP service, as a local absolute path",
      authz: "Account auth",
      authzHint: "When enabled, only users in the account table may access the FTP service",
      accounts: "Accounts",
      accountsHint:
        "Leave the password empty when editing an existing user to keep the current one; passwords are write-only and never echoed back",
      addAccount: "Add account",
      removeAccount: "Remove account",
      rowLabel: "Account {{index}}",
      userPlaceholder: "Username",
      passwordPlaceholder: "Password",
    },
    staticPeers: {
      title: "Static peers",
      hint: "Manually registered peer address book; changes apply after a node restart",
      empty: "No static peers registered",
      add: "Add peer",
      edit: "Edit",
      remove: "Remove peer",
      columnPeerId: "PeerId",
      columnAddrs: "Addresses",
      columnNote: "Note",
      columnAction: "Actions",
      loadFailed: "Failed to load static peers, please retry",
      editorAddTitle: "Add static peer",
      editorEditTitle: "Edit static peer",
      peerIdLabel: "PeerId",
      peerIdHint: "Peer identity, 43-45 base58 characters",
      peerIdLockedHint: "PeerId is immutable while editing; remove and re-add to change it",
      addrsLabel: "Address list",
      addrsGuide:
        "Purpose: addresses the node dials proactively after a restart. Syntax: ip/uport (QUIC) or ip/tport (TCP).",
      noteLabel: "Note",
      notePlaceholder: "Optional",
      save: "Save peer",
      saved: "Static peer saved",
      saveFailed: "Failed to save static peer",
      removed: "Static peer removed",
      removeFailed: "Failed to remove static peer",
      removeConfirmTitle: "Remove static peer?",
      removeConfirmDesc:
  ...
  contacts: {
    ...
    friends: {
      ...
      edit: "Edit",
      editTitle: "Edit friend profile",
      editDescription: "Customize display name and remark; visible only on this device",
      editNicknameLabel: "Display name",
      editNicknamePlaceholder: "Leave empty to show a short PeerId",
    ...
    authz: {
      action: "Role",
      dialogTitle: "Friend role",
      dialogDescription:
        "Roles decide which capability domains this friend can use; no binding = deny all by default",
      roleLabel: "Role",
      ...
      unbound: "Unbound",
      unboundHint: "No binding yet: an unbound friend is denied in all domains by default",
      roleRequired: "Pick a role first",
      expiryLabel: "Expiry",
      expiryNever: "Never expires",
      expiryIn1d: "In 1 day",
      expiryIn7d: "In 7 days",
      expiryIn30d: "In 30 days",
      expiryCustom: "Custom Unix seconds",
      expiryCustomLabel: "Expiry Unix seconds",
      expiryInvalid: "Expiry must be a positive integer Unix timestamp",
      bind: "Bind",
      rebind: "Rebind",
      bindSuccess: "Role bound",
      bindFailed: "Failed to bind role",
      unbind: "Unbind",
      unbindSuccess: "Unbound; default-deny now applies",
      unbindFailed: "Failed to unbind",
      defaultRoleLabel: "Default role for new friends",
      defaultRoleHint: "New friends are automatically bound to this role; pick none to disable",
      defaultRoleNone: "Do not auto-bind",
      defaultRoleSaveSuccess: "Default role updated",
      defaultRoleSaveFailed: "Failed to save default role",
      loadFailed: "Failed to load role data",
      manager: {
        open: "Manage roles…",
        title: "Manage roles",
        description: "Create, edit, or delete custom roles; built-in roles cannot be changed or removed",
        newRole: "New role",
        edit: "Edit",
        delete: "Delete",
        formCreateTitle: "New role",
        formEditTitle: "Edit role",
        roleIdLabel: "Role ID",
        roleIdPlaceholder: "Lowercase letters, digits, or hyphens, 1-32 chars (^[a-z0-9-]{1,32}$)",
        roleIdInvalid: "Role ID must be lowercase letters, digits, or hyphens, 1-32 chars",
        nameLabel: "Name",
        namePlaceholder: "Display name",
        nameRequired: "Name is required",
        noteLabel: "Note (optional)",
        permissionsLabel: "Permissions",
        permissionsHint: "Pick at least 1",
        permissionsRequired: "Pick at least 1 permission",
        save: "Save",
        back: "Back to list",
        ...
        deleteConfirmDesc: "Delete \"{{name}}\"? Bindings referencing it will be denied as a missing role.",
        deleteSuccess: "Role deleted",
        deleteFailed: "Failed to delete role",
        permChatSend: "Send messages",
        permChatAttachment: "Send attachments",
        permA2aDiscover: "Discover agents",
        permA2aInvoke: "Invoke agents",
        permAcpSession: "ACP sessions",
        permAcpExecute: "ACP execution",
        permLlmBorrow: "Borrow quota",
        permRepairDiag: "Run diagnostics",
        permRepairFix: "Apply repairs",
      },
    },
    addFriend: {
  ...
  // Contract §20 (service master) keys: mirror zh-CN structure (typeof zhCN parity).
  services: {
    title: "Service Master",
    description: "Manage node service switches; changes take effect on next node start",
    ...
    disable: "Disable",
    saveSuccess: "Saved",
    saveFailed: "Failed to save service switch",
    loadFailed: "Failed to load service list",
    restartBadge: "Restart required",
    restartHint: "Node is running: changes take effect after node restart",
    kindBoolean: "Boolean gate",
    kindExplicit: "Explicit",
    kindAdopted: "Adopted",
    kindBooleanHint: "New explicit switch, safe default off",
    kindExplicitHint: "Switch AND config, default on without behavior change",
    kindAdoptedHint: "Adopted switch: registry entry wins, falls back to legacy config",
    name: {
      serveLlmShare: "LLM Lending",
      serveTunnel: "Tunnel Serve",
      serveA2a: "A2A Agent Service",
      serveAcp: "ACP Hosting",
      netRendezvousRegister: "Rendezvous Register",
      netRelay: "Relay",
      netObserve: "Address Observation",
      serveRendezvousServer: "Rendezvous Server",
      discoveryMdns: "LAN Discovery (mDNS)",
      netLanOnly: "LAN-only Mode",
    },
  },
};
