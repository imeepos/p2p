const zhCN = {
  common: {
    ...
    validation: {
      ...
      ftpRootRequired: "FTP 根目录不能为空",
      ftpUserRequired: "用户名不能为空",
      ftpUserDuplicate: "用户名重复",
      ftpPasswordRequired: "新用户必须设置密码",
      peerIdRequired: "PeerId 不能为空",
      peerIdFormat: "PeerId 应为 43-45 位 base58 字符",
    },
    addressList: {
      add: "添加地址",
      remove: "删除地址",
  ...
  settings: {
    ...
    ftp: {
      title: "FTP 服务",
      hint: "FTP 文件服务的根目录与账号配置；修改保存后需重启节点生效",
      root: "根目录",
      rootHint: "FTP 服务对外暴露的目录，使用本机绝对路径",
      authz: "账号鉴权",
      authzHint: "开启后仅账号表内的用户可访问 FTP 服务",
      accounts: "账号表",
      accountsHint: "编辑既有用户时密码留空 = 保留原密码；密码仅写入，保存后不再回显",
      addAccount: "添加账号",
      removeAccount: "删除账号",
      rowLabel: "账号 {{index}}",
      userPlaceholder: "用户名",
    ...
    staticPeers: {
      ...
      columnNote: "备注",
      columnAction: "操作",
      loadFailed: "静态对端加载失败，请重试",
      editorAddTitle: "添加静态对端",
      editorEditTitle: "编辑静态对端",
      peerIdLabel: "PeerId",
      peerIdHint: "对端身份，43-45 位 base58",
      peerIdLockedHint: "编辑时 PeerId 不可修改；如需变更请删除后重新添加",
      addrsLabel: "地址列表",
      addrsGuide: "用途：节点重启后主动连接的地址。语法：ip/u端口（QUIC）或 ip/t端口（TCP）。",
      noteLabel: "备注",
      notePlaceholder: "可选",
      save: "保存对端",
      saved: "静态对端已保存",
  ...
  contacts: {
    ...
    friends: {
      ...
      edit: "编辑资料",
      editTitle: "编辑好友资料",
      editDescription: "自定义显示名与备注，仅本机可见",
      editNicknameLabel: "显示名称",
      editNicknamePlaceholder: "留空则显示 PeerId 缩略",
    ...
    authz: {
      action: "角色",
      dialogTitle: "好友角色",
      dialogDescription: "绑定角色决定该好友可用的能力域；无绑定 = 全域默认拒绝",
      roleLabel: "角色",
      ...
      expiredBadge: "已过期",
      unbound: "未绑定",
      unboundHint: "该好友暂无绑定：未绑定角色时全域默认拒绝",
      roleRequired: "请先选择角色",
      expiryLabel: "过期时间",
      expiryNever: "永不过期",
      expiryIn1d: "1 天后过期",
      expiryIn7d: "7 天后过期",
      expiryIn30d: "30 天后过期",
      expiryCustom: "自定义 Unix 秒",
      expiryCustomLabel: "到期 Unix 秒",
      expiryInvalid: "到期时间须为正整数 Unix 秒",
      bind: "绑定",
      rebind: "改绑",
      bindSuccess: "角色已绑定",
      bindFailed: "角色绑定失败",
      unbind: "解绑",
      unbindSuccess: "已解绑，全域默认拒绝生效",
      unbindFailed: "解绑失败",
      defaultRoleLabel: "加好友默认角色",
      defaultRoleHint: "新好友自动绑定该角色；选「不自动绑定」禁用",
      defaultRoleNone: "不自动绑定",
      defaultRoleSaveSuccess: "默认角色已更新",
      defaultRoleSaveFailed: "默认角色保存失败",
      loadFailed: "角色数据加载失败",
      manager: {
        open: "管理角色…",
        title: "管理角色",
        description: "创建、编辑或删除自定义角色；内建角色不可改不可删",
        newRole: "新建角色",
        edit: "编辑",
        delete: "删除",
        formCreateTitle: "新建角色",
        formEditTitle: "编辑角色",
        roleIdLabel: "角色 ID",
        roleIdPlaceholder: "小写字母、数字或连字符，1-32 位（^[a-z0-9-]{1,32}$）",
        roleIdInvalid: "角色 ID 须为小写字母、数字或连字符，1-32 位",
        nameLabel: "名称",
        namePlaceholder: "角色显示名",
        nameRequired: "请填写角色名称",
        noteLabel: "备注（可选）",
        permissionsLabel: "权限",
        permissionsHint: "至少勾选 1 项",
        permissionsRequired: "至少勾选 1 项权限",
        save: "保存",
        back: "返回列表",
        createSuccess: "角色已创建",
        createFailed: "角色创建失败",
        ...
        deleteConfirmDesc: "确认删除「{{name}}」？引用该角色的绑定将因角色缺失被默认拒绝。",
        deleteSuccess: "角色已删除",
        deleteFailed: "角色删除失败",
        permChatSend: "发送消息",
        permChatAttachment: "发送附件",
        permA2aDiscover: "发现 Agent",
        permA2aInvoke: "调用 Agent",
        permAcpSession: "ACP 会话",
        permAcpExecute: "ACP 执行",
        permLlmBorrow: "借用额度",
        permRepairDiag: "运行诊断",
        permRepairFix: "执行修复",
      },
    ...
    agents: {
      ...
      share: {
        title: "分享智能体",
        description: "为 {{agentName}} 生成邀请凭证",
        inviteePeer: "被邀请方 PeerId",
        inviteePeerPlaceholder: "输入被邀请方的 PeerId",
        token: "邀请凭证",
        generate: "生成邀请",
        generating: "生成中...",
        generated: "邀请已生成",
  ...
  remoteAccess: {
    title: "远程访问",
    description:
      "把本机任意 http/ws 服务分享给指定节点，或访问对方节点开放的服务（经 p2p 隧道本地回环反代）",
    form: {
      url: "DSH 启动 URL",
      urlPlaceholder: "http://127.0.0.1:3080/?token=…",
      urlHint: "粘贴 A 机 dsh web 启动时打印的完整 URL（127.0.0.1 回环地址）",
      peer: "被访节点 PeerId",
      peerPlaceholder: "A 机 p2p 节点的 PeerId（base58）",
      peerHint: "隧道经本机 p2p 节点拨向被访节点，身份以节点握手为准",
      open: "开启远程访问",
      opening: "开启中…",
      close: "关闭远程访问",
    },
    status: {
      ...
      copyUrl: "复制链接",
      copied: "链接已复制",
      reopenHint: "浏览器未自动打开时，复制入口链接手动打开",
    },
    error: {
      lastError: "最近错误",
    ...
    tunnel: {
      bannerSuccessTitle: "隧道已建立",
      bannerFailTitle: "操作失败",
      bannerTarget: "分享目标",
      bannerPeer: "对端节点",
      bannerCode: "错误码",
      wsAddr: "WS 地址",
      wsHint: "ws 客户端可直连此地址（与 http 入口同端口，反代透传 ws 升级）",
      copyWs: "复制 WS 地址",
      wsCopied: "WS 地址已复制",
      copyFailed: "复制失败",
      friendPick: "从好友选择",
      friendPickPlaceholder: "选择通讯录好友",
      friendPickSearch: "搜索好友昵称或 PeerId",
      friendPickEmpty: "暂无好友，可直接手填 PeerId",
      peerManualHint: "可从上方好友选择器带入，或直接粘贴 base58 PeerId",
      guideTitle: "对端使用说明",
      guideGuiLine:
        "对端 GUI：远程访问页 → 通用服务，端口 {{port}}、PeerId {{peer}}",
      guideCliLine: "对端 CLI：{{cmd}}",
      guideCopy: "复制说明",
      guideCopied: "说明已复制",
      guideSelfPeerMissing: "本机节点未启动，生成说明需先获取本机 PeerId",
      allowTablePort: "端口",
      allowTableAddedAt: "加入时间",
      allowTableStatus: "状态",
      code: {
        bad_ticket: "票据校验失败",
        target_not_allowed: "目标不在白名单",
        busy: "对端并发已满",
        dial_failed: "对端服务拨号失败",
        io: "数据面读写错误",
        shutdown: "对端停机中",
      },
    },
  ...
  llmShare: {
    ...
    overview: {
      ...
      refresh: "刷新统计",
      statEntries: "流水笔数",
      statTokens: "合计 tokens",
      statLentOut: "累计出借 tokens",
      statBorrowed: "累计借入 tokens",
      goBorrow: "去借用",
      goLedger: "账本明细",
      goOffer: "去发布声明",
      recentTitle: "最近流水",
      allowlistLabel: "白名单",
      allowlistValue: "{{count}} 位借方",
      providersLabel: "上游配置",
      providersValue: "{{count}} 条",
      serveLabel: "常驻代理",
    },
    panels: {
      offer: "能力发布",
  ...
  // 契约 §20（服务总控）键块：键名清单即 wsm-b4 消费契约，值为中文初稿。
  services: {
    title: "服务总控",
    description: "统一管理节点各服务的开关；修改在下次节点启动后生效",
    columnService: "服务",
    columnKind: "类型",
    columnState: "状态",
    columnAction: "操作",
    ...
    loadFailed: "服务清单加载失败",
    restartBadge: "重启生效",
    restartHint: "节点运行中：修改将在重启节点后生效",
    kindBoolean: "布尔闸",
    kindExplicit: "显式化",
    kindAdopted: "收编",
    kindBooleanHint: "新增显式开关，安全默认关闭",
    kindExplicitHint: "开关与配置双条件，默认开启不改行为",
    kindAdoptedHint: "既有开关收编：注册表条目优先，缺失回落原配置",
    name: {
      serveLlmShare: "LLM 借出服务",
      serveTunnel: "隧道被访服务",
      serveA2a: "A2A Agent 服务",
      serveAcp: "ACP 托管服务",
      netRendezvousRegister: "Rendezvous 注册",
      netRelay: "Relay 中继",
      netObserve: "地址观测上报",
      serveRendezvousServer: "Rendezvous 服务端",
      discoveryMdns: "局域网发现（mDNS）",
      netLanOnly: "仅局域网模式",
    },
  },
};
